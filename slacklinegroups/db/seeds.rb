...
vegasSlacklife = Group.new(name: 'Vegas Slacklife', slug: 'vegas-slacklife', type: :facebook_group)
...
lvSlacklineGroups = Group.new(name: 'LV Slackline Groups', slug: 'lv-slackline-group', type: :facebook_group)
...
lvSlackers = Group.new(name: 'Las Vegas Slackers', slug: 'las-vegas-slackers', type: :facebook_page)
...
wcSlackers = Group.create(name: 'West Coast Slackers', slug: 'west-coast-slackers', type: :facebook_group)
...
sdSlackers = Group.create(name: 'San Diego Slackers', slug: 'san-diego-slackers', type: :facebook_group)
...
500.times do |n|
  ...
  random_group = Group.new(name: "Random Group #{n}", slug: ('a'..'z').to_a.shuffle[0,8].join, type: :facebook_group)
